...
<html lang="id">
  <head>
    ...
    <title>Profil SDN Lebak Wangi</title>
    <link
  ...
  <body>
    ...
    >
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">SDN Lebak Wangi</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="profil.php">Profil Guru</a>
            </li>
            <li class="nav-item">
            ...
            <a href="../logAwal.php" style="font-family: Poppins; border-radius: 10px; color: white; padding:8px;">Logout
</a>
            </li>
          </ul>
        </div>
    ...
    <div class="container mt-4">
      <!-- Beranda -->
      <!-- Form Pendaftaran -->
      <div class="container py-5 p-4" style="background-color: green; border-radius: 20px; margin-top: 8rem; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.2);">
    <h2 class="mb-4" style="color: white; font-family:poppins; font-weigth: 500; text-align:center;">Formulir Pendaftaran PPDB</h2>
    <form action="../pesan/simpan_ppdb.php" method="POST">
  ...
  <div class="mb-3">
    ...
    <input type="tel" name="no_telepon" pattern="[0-9]{10,13}" class="form-control" required>
    <div class="form-text">Masukkan 10-13 digit angka.</div>
  </div>
  ...
  <div class="mb-3">
    ...
    <textarea name="alamat" class="form-control" minlength="10" required></textarea>
  </div>
      <div style="display: flex; justify-content: flex-end;">
  <button type="submit" class="btn-blue">Kirim Pendaftaran</button>
</div>
    </form>
  </div>

      <!-- Program Pendidikan -->
      <section id="program" class="bg-light py-5 p-4">
        <h2 class="sub2">Program Pendidikan</h2>
        <p class="desc">
          SD Negeri Lebakwangi menyelenggarakan berbagai program pendidikan yang dirancang untuk mendukung perkembangan potensi peserta didik secara menyeluruh, baik dalam aspek akademik maupun non-akademik. Program pendidikan yang diterapkan disusun berdasarkan Kurikulum Merdeka dan dikembangkan sesuai dengan kebutuhan serta karakteristik peserta didik di lingkungan sekolah.
        </p>
      </section>
