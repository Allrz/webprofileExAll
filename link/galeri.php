  ...
  <body>
    ...
    <div class="container mt-4">
      ...
      <section id="about" class="py-5 p-4">
        <h2 class="sub">Fasilitas Sekolah</h2>
        <div
        ...
        >
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="../foto/g1.jpeg" class="d-block w-100" alt="Gambar 1" />
              <div class="carousel-caption d-none d-md-block">
                <h5>Sekolah</h5>
                <p>Ini merupakan halaman sekolah SD Negeri Lebakwangi</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="../foto/g2.jpeg" class="d-block w-100" alt="lapangan" />
              <div class="carousel-caption d-none d-md-block">
                <h5>Lapangan Sekolah</h5>
                <p>Ini merupakan halaman sekolah SDN Lebak Wangi</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="../foto/g3.JPG" class="d-block w-100" alt="Gambar 3" />
              <div class="carousel-caption d-none d-md-block">
                <h5>Perpustakaan</h5>
                <p>Ini merupakan perpustakaan sekolah SDN Lebak Wangi</p>
              </div>
            </div>
          </div>
          <a
...
<script>
  ...
  <button type="submit" class="btn btn-primary" style="font-family: poppins">Kirim Pesan</button>
          ...
          <footer class="bg-dark text-white text-center py-3">
            <p>&copy; 2023 SDN Lebak Wangi. Semua hak dilindungi.</p>
            <p>
