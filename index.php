  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="interfaceuser/profil.php">Profil Guru</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="interfaceuser/galeri.php">Galeri</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="interfaceuser/daftar.php">Pendaftaran</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container mt-4">
      ...
      <section id="about" class="py-5 p-4">
        ...
        <p class="desc">
          Selamat datang di website resmi SD Negeri Lebakwangi! SD Negeri Lebakwangi
          ...
          di SD Negeri Lebbakwangi. Mari bersama-sama menciptakan lingkungan
